                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 text-right">
                                    <strong class="text-black newTotalPrice">{{ session()->get('total_price') ?? '' }}
                                        ₺</strong>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-primary btn-lg py-3 btn-block paymentButtonCredit" style="font-size: 15px; padding: revert">Kartla Öde</button>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-primary btn-lg py-3 btn-block paymentButton" style="font-size: 15px; padding: revert">Kapıda Öde</button>
                                </div>
                            </div>
...
@section('customjs')
    <script>
        ...
        $(document).on('click', '.paymentButtonCredit', function(e) {
            var url = "{{ route('sepet.form.credit') }}";
