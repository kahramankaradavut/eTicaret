                    ...
                    <div class="col-md-6 mb-5 mb-md-0">
                        ...
                        <div class="p-3 p-lg-5 border">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="c_fidentity" class="text-black">TC Kimlik Numarası <span
                                ...
                                <div class="col-md-12">
                                    <label for="c_fsurname" class="text-black">Soyad <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="form-group row mb-5">
                                <div class="col-md-6">
                                    <label for="c_email_address" class="text-black">E-Posta <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="p-3 p-lg-5 border">
                                    ...
                                    <div class="input-group w-75">
                                        <input type="text" readonly class="form-control"
                                            value="{{ session()->get('coupon_code') ?? '' }}" id="c_code"
                                            placeholder="Kupon Kod" aria-label="Coupon Code"
                                ...
                                <div class="p-3 p-lg-5 border">
                                    <table class="table site-block-order-table mb-5">
                                        ...
                                        <tbody>
                                            ...
                                            @if (session()->get('coupon_price'))
                                                <tr>
                                                    ...
                                                    <td class="text-black font-weight-bold">
                                                        <strong>{{ session()->get('coupon_price') }} ₺</strong></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td class="text-black font-weight-bold"><strong>İndirim</strong></td>
                                            ...
                                            @endif
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Kapıda Ödeme Bedeli</strong></td>
                                                <td class="text-black font-weight-bold"><strong>90 ₺</strong></td>
                                            </tr>
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Toplam Tutar</strong></td>
                                                <td class="text-black font-weight-bold">
                                                    <strong>{{ session()->get('total_price') ?? 0 }} ₺</strong></td>
                                            </tr>
